...
# CAM settings, NO support for other res then (1024, 768)!
dartconfig = {"cam": {"res": (1024, 768), "camurl": "http://10.1.1.100:8000"},
              ...
              "DartHit": {"WriteFramesToSeparateFiles": False, "DartHitMinArea": 500, "DartHitMaxArea": 1300,
                          "DartHitFrames": 0},
              ...
              "IO": {"CalButton": 23, "GameButton": 24, "OnLed": 25, "CalLed": 8, "GameLed": 7, "HitLed": 18,
                     "GameSwitch1": 9, "GameSwitch2": 10},

              "Main": {"MaxFrameRate": 10},

              "Vision": {"WriteFramesToSeparateFiles": False, "PrintFrameRate": False, "RecordRaw": False,
                         "RecordCv": False, "CamType": "NetCam"},

              "Recorder": {"VideoFileDir": "/home/pi/DartScore/Videos/", "VideoFile": "/home/pi/DartScore/video.avi",
                           "tempfile": "/ram/videos/", "MinSize": 70000, "MaxFrames": 600},
              }
