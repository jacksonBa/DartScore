...
class Sectors(object):
    ...
    # TODO: parameterize the filter and tresh (threshold) values
...
if __name__ == "__main__":
    ...
    cam = Cam.create_cam("VIDEO")

    cam.initialize(r'D:\Storage\dev\DartScore\Testdata\Videos\dartscore_20191107_152701.avi')
