...
class CamMountingLoop(StateLoop.StateLoop):
    ...
    def draw(self, frame):
        ...
        cv2.putText(frame, "Mount to fit bullseye inside the box", (self._center[0]+15, self._center[1]),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
        cv2.line(frame, self._center, (self._center[0], 0), dartconfig['color']['bullseye'], 2)
        cv2.putText(frame, "Put this line inside the 20-sector", (self._center[0]-100,100), cv2.FONT_HERSHEY_SIMPLEX,
                    0.5, (255, 255, 255), 1)
