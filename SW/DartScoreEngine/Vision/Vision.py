...
class Vision(object):
    ...
    def draw(self, frame, framerate):
        ...
        if dartconfig["Vision"]["PrintFrameRate"]:
            cv2.putText(frame, "Framerate: " + str(framerate), (5, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                        (255, 255, 255), 2)
...
if __name__ == '__main__':
    ...
    # cap = cv2.VideoCapture(r'C:\Users\par\OneDrive\Documents\GitHub\DartScore\Testdata\Videos\dartscore_
    # 20191107_152701.avi')
